...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Legends Battlegrounds Wiki',
    description: 'Copyright and intellectual property information for Legends Battlegrounds Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Legends Battlegrounds Wiki',
      description: 'Copyright and intellectual property information for Legends Battlegrounds Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Legends Battlegrounds Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Legends Battlegrounds Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Legends Battlegrounds Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Arts of Vermillion</strong> - Creators of the Legends Battlegrounds game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Legends Battlegrounds</strong> - Trademark of Arts of Vermillion</li>
              <li><strong>Legends Battlegrounds Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Legends Battlegrounds Wiki.
            </p>
            ...
            <p>
              ...
              Legends Battlegrounds Wiki<br />
              Email: <a href="mailto:dmca@legendsbattlegrounds.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@legendsbattlegrounds.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Legends Battlegrounds Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Legends Battlegrounds Wiki (legendsbattlegrounds.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@legendsbattlegrounds.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@legendsbattlegrounds.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@legendsbattlegrounds.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@legendsbattlegrounds.wiki</a>
            </p>
            <p>
