...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Legends Battlegrounds Wiki",
    description: "Read the Terms of Service for Legends Battlegrounds Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Legends Battlegrounds Wiki",
      description: "Terms and conditions for using Legends Battlegrounds Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Legends Battlegrounds Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Legends Battlegrounds Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Legends Battlegrounds Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Legends Battlegrounds Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Legends Battlegrounds". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and PvP strategies</li>
              <li>Character moveset and combo guides</li>
              <li>Tier list and character rankings</li>
              <li>Technique and gamepass guides</li>
              <li>Achievement walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Legends Battlegrounds Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation (Roblox) or the official developers of Legends Battlegrounds. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Legends Battlegrounds Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation (Roblox) and/or the developers of Legends Battlegrounds. We use such
            ...
            <ul>
              ...
              <li><strong>Game Updates:</strong> Roblox game content and updates may change without notice. We are not responsible for in-game changes or access.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, LEGENDS BATTLEGROUNDS WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Legends Battlegrounds Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@legendsbattlegrounds.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@legendsbattlegrounds.wiki</a>
            </p>
            <p>
