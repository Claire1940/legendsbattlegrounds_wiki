...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.legendsbattlegrounds.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Legends Battlegrounds Wiki'
